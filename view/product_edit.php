    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <form action="?mod=product&act=update" method="POST" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="file" accept="image/*" onchange="loadFile(event)" id="product_image" name="product_image" value="">
                <input type="text" name="product_image" value="<?= $product['product_image'] ?>" hidden>
                <br>
                <img src="public/images/<?= $product['product_image'] ?>" id="output" width="50px" />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="" placeholder="Nhập vào giá bán" name="product_price" value="<?= $product['product_price'] ?>">
            </div>
